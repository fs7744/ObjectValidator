...
namespace ObjectValidator
{
    public static partial class Syntax
    {
        ...
        {
            return new GreaterThanOrEqualDateTimeChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, DateTime> LessThan<T>(this IFluentRuleBuilder<T, DateTime> builder, DateTime value)
        {
            return new LessThanDateTimeChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new MustChecker<T, TProperty>(func, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new NotEqualChecker<T, TProperty>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new LengthChecker<T>(length, length, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new LengthChecker<T>(length, -1, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new RegexChecker<T>(pattern, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new RegexChecker<T>(regex, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, string> Email<T>(this IFluentRuleBuilder<T, string> builder)
        {
            return new RegexChecker<T>(EmailRegex, builder.Validation).SetValidate(builder).OverrideError("The value is not email address");
        }
        ...
        {
            return new BetweenFloatChecker<T>(min, max, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new GreaterThanIntChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, double> GreaterThan<T>(this IFluentRuleBuilder<T, double> builder, double value)
        {
            return new GreaterThanDoubleChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new GreaterThanOrEqualFloatChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, int> GreaterThanOrEqual<T>(this IFluentRuleBuilder<T, int> builder, int value)
        {
            return new GreaterThanOrEqualIntChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new GreaterThanOrEqualDecimalChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, long> GreaterThanOrEqual<T>(this IFluentRuleBuilder<T, long> builder, long value)
        {
            return new GreaterThanOrEqualLongChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, float> LessThan<T>(this IFluentRuleBuilder<T, float> builder, float value)
        {
            return new LessThanFloatChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new LessThanDecimalChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, long> LessThan<T>(this IFluentRuleBuilder<T, long> builder, long value)
        {
            return new LessThanLongChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new LessThanOrEqualIntChecker<T>(value, builder.Validation).SetValidate(builder);
        }

        public static IRuleMessageBuilder<T, double> LessThanOrEqual<T>(this IFluentRuleBuilder<T, double> builder, double value)
        {
            return new LessThanOrEqualDoubleChecker<T>(value, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new NotRegexChecker<T>(pattern, builder.Validation).SetValidate(builder);
        }
        ...
        {
            return new NotRegexChecker<T>(pattern, options, builder.Validation).SetValidate(builder);
        }
